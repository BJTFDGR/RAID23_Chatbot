...
# see how learninnig rate works
# python dialogue_system/main.py --device 4 --training_data_type 1 --trainingdata_org_type 0 --prefix_type 4 --api_selection 2 --learning_rate 0.0001; 
# python dialogue_system/main.py --device 4 --training_data_type 1 --trainingdata_org_type 1 --prefix_type 4 --api_selection 2 --learning_rate 0.0001; 
# python dialogue_system/main.py --device 4 --training_data_type 1 --trainingdata_org_type 2 --prefix_type 4 --api_selection 2 --learning_rate 0.0001; 
# python dialogue_system/main.py --device 4 --training_data_type 1 --trainingdata_org_type 3 --prefix_type 4 --api_selection 2 --learning_rate 0.0001; 
# python dialogue_system/main.py --device 4 --training_data_type 1 --trainingdata_org_type 4 --prefix_type  4 --api_selection 2 --learning_rate 0.0001; 
# python dialogue_system/main.py --device 4 --training_data_type 0 --trainingdata_org_type 0 --prefix_type 4 --api_selection 2 --learning_rate 0.0001;
# python dialogue_system/main.py --device 4 --training_data_type 0 --trainingdata_org_type 1 --prefix_type 4 --api_selection 2 --learning_rate 0.0001;
# python dialogue_system/main.py --device 4 --training_data_type 0 --trainingdata_org_type 2 --prefix_type 4 --api_selection 2 --learning_rate 0.0001;

# python dialogue_system/main.py --device 4 --training_data_type 1 --trainingdata_org_type 0 --prefix_type 4 --api_selection 2 --learning_rate 0.001; 
# python dialogue_system/main.py --device 4 --training_data_type 1 --trainingdata_org_type 1 --prefix_type 4 --api_selection 2 --learning_rate 0.001; 
# python dialogue_system/main.py --device 4 --training_data_type 1 --trainingdata_org_type 2 --prefix_type 4 --api_selection 2 --learning_rate 0.001; 
# python dialogue_system/main.py --device 4 --training_data_type 1 --trainingdata_org_type 3 --prefix_type 4 --api_selection 2 --learning_rate 0.001; 
# python dialogue_system/main.py --device 4 --training_data_type 1 --trainingdata_org_type 4 --prefix_type  4 --api_selection 2 --learning_rate 0.001; 
# python dialogue_system/main.py --device 4 --training_data_type 0 --trainingdata_org_type 0 --prefix_type 4 --api_selection 2 --learning_rate 0.001;
# python dialogue_system/main.py --device 4 --training_data_type 0 --trainingdata_org_type 1 --prefix_type 4 --api_selection 2 --learning_rate 0.001;
# python dialogue_system/main.py --device 4 --training_data_type 0 --trainingdata_org_type 2 --prefix_type 4 --api_selection 2 --learning_rate 0.001;




python dialogue_system/main.py --device 5 --training_data_type 0 --trainingdata_org_type 0 --prefix_type 3 --api_selection 2 --job_name BBm;
python dialogue_system/main.py --device 5 --training_data_type 0 --trainingdata_org_type 1 --prefix_type 3 --api_selection 2 --job_name BBm;
python dialogue_system/main.py --device 5 --training_data_type 0 --trainingdata_org_type 2 --prefix_type 3 --api_selection 2 --job_name BBm;
