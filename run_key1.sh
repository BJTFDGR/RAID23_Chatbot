...
# python dialogue_system/main.py --device 3 --training_data_type 1 --trainingdata_org_type 0 --prefix_type 3 --api_selection 1 --learning_rate 0.0001; 
# python dialogue_system/main.py --device 3 --training_data_type 1 --trainingdata_org_type 1 --prefix_type 3 --api_selection 1 --learning_rate 0.0001; 
# python dialogue_system/main.py --device 3 --training_data_type 1 --trainingdata_org_type 2 --prefix_type 3 --api_selection 1 --learning_rate 0.0001; 
# python dialogue_system/main.py --device 3 --training_data_type 1 --trainingdata_org_type 3 --prefix_type 3 --api_selection 1 --learning_rate 0.0001; 
# python dialogue_system/main.py --device 3 --training_data_type 1 --trainingdata_org_type 4 --prefix_type 3 --api_selection 1 --learning_rate 0.0001; 
# python dialogue_system/main.py --device 3 --training_data_type 0 --trainingdata_org_type 0 --prefix_type 3 --api_selection 1 --learning_rate 0.0001;
# python dialogue_system/main.py --device 3 --training_data_type 0 --trainingdata_org_type 1 --prefix_type 3 --api_selection 1 --learning_rate 0.0001;
# python dialogue_system/main.py --device 3 --training_data_type 0 --trainingdata_org_type 2 --prefix_type 3 --api_selection 1 --learning_rate 0.0001;

# python dialogue_system/main.py --device 3 --training_data_type 1 --trainingdata_org_type 0 --prefix_type 3 --api_selection 1 --learning_rate 0.001; 
# python dialogue_system/main.py --device 3 --training_data_type 1 --trainingdata_org_type 1 --prefix_type 3 --api_selection 1 --learning_rate 0.001; 
# python dialogue_system/main.py --device 3 --training_data_type 1 --trainingdata_org_type 2 --prefix_type 3 --api_selection 1 --learning_rate 0.001; 
# python dialogue_system/main.py --device 3 --training_data_type 1 --trainingdata_org_type 3 --prefix_type 3 --api_selection 1 --learning_rate 0.001; 
# python dialogue_system/main.py --device 3 --training_data_type 1 --trainingdata_org_type 4 --prefix_type 3 --api_selection 1 --learning_rate 0.001; 
# python dialogue_system/main.py --device 3 --training_data_type 0 --trainingdata_org_type 0 --prefix_type 3 --api_selection 1 --learning_rate 0.001;
...
python dialogue_system/main.py --device 4 --training_data_type 1 --trainingdata_org_type 3 --prefix_type 3 --api_selection 1 --query_number 500; 
# debug
# python dialogue_system/main.py --device 4 --training_data_type 1 --trainingdata_org_type 2 --prefix_type 3 --api_selection 1 --job_name BB --no_train --no_eval  --save_model_path /home/chenboc1/localscratch2/chenboc1/Adver_Conv/result/models/demo_job/1110_181539 